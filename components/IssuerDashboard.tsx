...
export default function IssuerDashboard() {
    ...
    if (!currentUser) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[400px] space-y-8">
                ...
                <Button onClick={() => registerUser('ORGANIZATION', 'ISSUER', { name: 'New University', address: '', registrationId: '' })} className="gap-2">
    ...
    const submissions = ledger.filter(tx => tx.type === 'PORTFOLIO_SUBMISSION' && tx.details?.targetOrgDid === currentUser.did);
